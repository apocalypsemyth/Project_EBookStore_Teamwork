...
{
    public partial class BookListSearchIETrue : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                else // 查詢輸入關鍵字的資料 // 顯示查詢資料的上、下架商品的分類按鈕
                {
                    ...
                    this.btnSearchIETrue.BorderColor = System.Drawing.Color.AliceBlue;
                    this.btnSearchIETrue.BackColor = System.Drawing.Color.AliceBlue;
