    ...
    <div class="row align-items-center justify-content-center">
        <div class="col-md-8">
            <asp:Repeater ID="rptSearchedBookList" runat="server">
                <ItemTemplate>
                    <div class="card mb-3 mx-4 mx-md-0 rounded-3">
                        <div class="row g-0">
                            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center">
                                ...
                                %>'>
                                    <a href="BookDetail.aspx?ID=<%# Eval("BookID") %>" title="前往查看：<%# Eval("BookName") %>">
                                        <img src="<%# Eval("Image") %>" alt="<%# Eval("BookName") %>">
                                    </a>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="col-12 col-md-8">
                                <div class="card-body d-flex flex-column align-items-center justify-content-center align-items-md-start justify-content-md-start">
                                    <a style="text-decoration: none;" href="BookDetail.aspx?ID=<%# Eval("BookID") %>" title="前往查看：<%# Eval("BookName") %>">
